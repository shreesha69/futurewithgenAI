...
// sample recent testimonials or events
const testimonies = [
  {
...
const TestimonySection = () => {
  ...
  return (
    <section id="testimonies" className="py-32 px-6 relative overflow-hidden section-fade-primary video-bg-light particle-bg-light">
      ...
      {/* Dramatic Animated Mesh Gradient */}
      ...
      <div className="max-w-6xl mx-auto relative z-10" ref={ref}>
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-mono-display text-primary font-bold">Testimonials</span>
          </motion.div>
          ...
          >
            Hear from participants who attended our recent{" "}
            <span className="text-primary font-semibold">GenAI workshops</span>.
          </motion.p>
        </motion.div>
