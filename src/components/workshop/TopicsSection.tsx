...
const TopicsSection = () => {
  ...
  return (
    <section id="topics" className="py-32 px-6 relative overflow-hidden section-fade-primary video-bg-light particle-bg-light neural-network-bg cyber-grid-bg">
      ...
      {/* Neural network particles for topics section */}
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(20)].map((_, i) => (
          <motion.div
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-mono-display text-primary font-bold">Advanced Curriculum</span>
          </motion.div>
          ...
          <h2 className="text-display-xl mb-6 leading-tight text-shadow-strong">
            ...
            />
            <br />
            <span className="text-gradient-animated">Master GenAI</span>
          </h2>
          ...
          >
            ...
            <span className="text-primary font-semibold">full generative AI stack</span>{" "}
        ...
        >
          {topics.map((topic, i) => (
            <motion.div
              key={topic.title}
              className={`glass-advanced rounded-2xl p-8 hover-lift interactive-card magnetic-element group ${
