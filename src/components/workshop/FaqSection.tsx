...
const faqs = [
  {
    ...
    answer: "Generative AI refers to models that can create text, images, code, and other data by learning patterns from large datasets.",
  },
  {
    question: "Who should attend this workshop?",
    answer: "Developers, designers, product managers, and anyone curious about building with GenAI are welcome.",
  },
  {
    question: "Do I need prior AI experience?",
    answer: "No – the workshop covers fundamentals and moves to hands-on projects suitable for beginners and intermediates.",
  },
];
      ...
      <svg className="absolute inset-0 w-full h-full opacity-10" viewBox="0 0 100 100" preserveAspectRatio="none">
        <defs>
          <pattern id="faq-pattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
            <circle cx="10" cy="10" r="1" fill="currentColor" className="text-primary animate-pulse">
      ...
      <div className="max-w-4xl mx-auto relative z-10" ref={ref}>
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-mono-display text-primary font-bold">FAQ</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-primary font-semibold">GenAI Workshop</span>.
          </motion.p>
        </motion.div>
